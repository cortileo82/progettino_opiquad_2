...
import { Pencil, Trash2, ChevronDown, Mail, UserCircle, Dumbbell, AlignLeft, Target } from 'lucide-react';
                            ...
                            <div className="flex flex-col">
                                ...
                                {type !== 'muscle-groups' && (
                                    <span className="text-[9px] font-black uppercase tracking-[0.3em] mt-0.5 text-primary">
                                        {/* ARCHITETTURA: Estrazione del ruolo dall'array di Spatie */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
                                {type === 'users' && (
                                    <>
                                        ...
                                        {/* ARCHITETTURA: Condizione aggiornata basata su Spatie per mostrare il PT */}
                                ...
                                {type === 'exercises' && (
                                    <div className="md:col-span-2">
                                        <DetailBox label="Descrizione Esercizio" value={item.description || 'Nessuna descrizione presente.'} icon={AlignLeft} isTextArea />
                                    </div>
                                )}
                            </div>
                        </div>
