...
import { ExerciseRow } from '@/components/custom/exercise-row';
    ...
    return (
        <div className="bg-card border-2 border-sidebar-border rounded-3xl p-6 shadow-sm overflow-hidden">
            ...
            <div className="flex flex-col gap-3">
                {weekFields.length === 0 ? (
                    <div className="text-center py-8 border-2 border-dashed border-sidebar-border rounded-2xl text-foreground/40 italic text-sm font-medium">
