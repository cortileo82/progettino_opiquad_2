...
import { Plus, Trash2, Dumbbell, ListChecks, Calendar, Hash, Clock, PlayCircle } from 'lucide-react';
                        ...
                        {(fields, { add, remove }) => (
                            <div className="flex flex-col gap-3">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-start">
                                            ...
                                            <div className="md:col-span-1">
                                                ...
                                                <button 
                                                    type="button" 
                                                    onClick={() => remove(name)}
                                                    className="w-full h-[44px] mt-[26px] flex items-center justify-center rounded-xl bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-all shadow-sm border border-red-500/20"
                                                >
                                                    <Trash2 size={18} />
                                                </button>
                                            </div>
                                ...
                                <div className="pl-2 mt-2">
                                    <button
                                        type="button"
                                        onClick={() => add({ week_number: 1, day_of_week: 'Lunedì' })}
