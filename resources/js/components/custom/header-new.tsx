...
import { LucideIcon, ArrowLeft, Crown } from 'lucide-react'; // Aggiunto Crown
...
interface HeaderNewProps {
    ...
    className?: string;
    isPremium?: boolean; // Assicuriamoci che sia presente
}
    ...
    return (
        <div className={cn("mb-10 border-b border-sidebar-border pb-8", className)}>
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                ...
                {/* DESTRA: Search Bar, Pulsanti e Azioni */}
