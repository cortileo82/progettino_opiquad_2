                ...
                <form onSubmit={handleSubmit} className="max-w-4xl space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 rounded-2xl border border-sidebar-border bg-sidebar shadow-sm">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black tracking-[0.2em] text-primary block ml-1"> Nome </label>
                            <input 
                                type="text" 
                        ...
                        {/* COGNOME */}
                        <div className="space-y-3">
                            <label className="text-[10px] font-black tracking-[0.2em] text-primary block ml-1"> Cognome </label>
                            <input 
                                type="text" 
                                ...
                                className="w-full rounded-xl border border-sidebar-border bg-background p-4 focus:border-primary focus:ring-1 focus:ring-primary transition-all font-bold text-sm outline-none italic"
                            />
                            {errors.last_name && <p className="text-red-500 text-xs normal-case not-italic">{errors.last_name}</p>}
                        </div>

                        {/* EMAIL */}
                        <div className="space-y-3">
                            <label className="text-[10px] font-black tracking-[0.2em] text-muted-foreground block ml-1"> Email </label>
                            <input 
                                type="email" 
                                value={data.email} 
                            ...
                            />
                            {errors.email && <p className="text-red-500 text-xs normal-case not-italic">{errors.email}</p>}
                        </div>

                        {/* PASSWORD */}
                        <div className="space-y-3">
                            <label className="text-[10px] font-black tracking-[0.2em] text-muted-foreground block ml-1"> Password </label>
                            <input 
                                type="password" 
                                value={data.password} 
                        ...
                        <div className={`space-y-3 transition-all duration-300 ${data.role === clientRoleSlug ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none h-0 md:h-auto overflow-hidden'}`}>
                            ...
                            {errors.trainer_id && <p className="text-red-500 text-xs normal-case not-italic">{errors.trainer_id}</p>}
                        </div>
