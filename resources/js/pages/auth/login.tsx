                            ...
                            <div className="mt-8 flex flex-col gap-4">
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="bg-white dark:bg-gray-900 px-2 text-gray-500 font-bold uppercase tracking-widest text-[10px]">
                                            Oppure accedi con
                                        </span>
                                    </div>
                                </div>

                                {/* IMPORTANTE: Usiamo un <a> nativo, NON il componente <Link> di Inertia! */}
                                <a 
                                    href="/auth/google" 
                                    className="w-full inline-flex justify-center items-center gap-3 px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl font-black uppercase text-[11px] tracking-widest text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-150 active:scale-95"
                                >
                                    {/* Icona Google SVG */}
